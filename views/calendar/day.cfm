...
<div class="page-container calendar-page">
    ...
    <div class="calendar-controls">
        <div class="view-toggle-group">
            <button class="view-toggle-btn active" data-view="day" data-testid="view-day" onclick="Polyculy.setView('day')">Day</button>
    ...
    <div class="calendar-grid day-view" id="calendarGrid" data-testid="calendar-grid">
