...
VALUES ('ok@iamedia.net', 'D3AD9315B7BE5DD53B31A273B3B3ABA5DEFE700808305AA16A3062B76658A791', 'OK', NULL, 'America/Los_Angeles', 1); //you@polyculy.demo

INSERT INTO users (email, password_hash, display_name, avatar_url, timezone_id, calendar_created)
VALUES ('pineleret@gmail.com', 'D3AD9315B7BE5DD53B31A273B3B3ABA5DEFE700808305AA16A3062B76658A791', 'OM', NULL, 'America/New_York', 1);

INSERT INTO users (email, password_hash, display_name, avatar_url, timezone_id, calendar_created)
VALUES ('jamie@polyculy.demo', 'D3AD9315B7BE5DD53B31A273B3B3ABA5DEFE700808305AA16A3062B76658A791', 'Anya', NULL, 'America/Chicago', 1);

INSERT INTO users (email, password_hash, display_name, avatar_url, timezone_id, calendar_created)
VALUES ('alex@polyculy.demo', 'D3AD9315B7BE5DD53B31A273B3B3ABA5DEFE700808305AA16A3062B76658A791', 'Alex', NULL, 'America/Denver', 1);

INSERT INTO users (email, password_hash, display_name, avatar_url, timezone_id, calendar_created)
VALUES ('casey@polyculy.demo', 'D3AD9315B7BE5DD53B31A273B3B3ABA5DEFE700808305AA16A3062B76658A791', 'Casey', NULL, 'America/Los_Angeles', 0);

INSERT INTO users (email, password_hash, display_name, avatar_url, timezone_id, calendar_created)
VALUES ('morgan@polyculy.demo', 'D3AD9315B7BE5DD53B31A273B3B3ABA5DEFE700808305AA16A3062B76658A791', 'Morgan', NULL, 'America/Los_Angeles', 0);

INSERT INTO users (email, password_hash, display_name, avatar_url, timezone_id, calendar_created)
VALUES ('sam@polyculy.demo', 'D3AD9315B7BE5DD53B31A273B3B3ABA5DEFE700808305AA16A3062B76658A791', 'Sam', NULL, 'America/Los_Angeles', 1);
...
VALUES (1, 'Doctor''s appointment',  '2026-04-12 09:00:00',  '2026-04-12 10:00:00', 'America/Los_Angeles', 'Annual checkup', '123 Medical Center Dr', 30, 'full_details');

INSERT INTO personal_events (owner_user_id, title, start_time, end_time, timezone_id, event_details, visibility_tier)
VALUES (1, 'Yoga Class',  '2026-04-15 07:00:00',  '2026-04-15 08:00:00', 'America/Los_Angeles', 'Morning flow', 'invisible');

INSERT INTO personal_events (owner_user_id, title, start_time, end_time, timezone_id, event_details, visibility_tier)
VALUES (1, 'Work Meeting',  '2026-04-16 14:00:00',  '2026-04-16 15:00:00', 'America/Los_Angeles', 'Sprint planning', 'full_details');
...
INSERT INTO personal_events (owner_user_id, title, start_time, end_time, timezone_id, event_details, visibility_tier)
VALUES (2, 'Book Club',  '2026-04-17 19:00:00',  '2026-04-17 21:00:00', 'America/New_York', 'Monthly meeting', 'full_details');
...
VALUES (1, 'Dinner with Casey',  '2026-04-19 19:30:00',  '2026-04-19 21:00:00', 'America/Los_Angeles', 'Dinner at the new Italian place', '456 Restaurant Row', 15, 'all', 'visible', 'tentative');
...
INSERT INTO shared_events (organizer_user_id, title, start_time, end_time, timezone_id, event_details, address, reminder_minutes, reminder_scope, participant_visibility, global_state)
VALUES (1, 'Lunch with Alex',  '2026-04-22 13:00:00',  '2026-04-22 14:00:00', 'America/Los_Angeles', 'Catch up over lunch', '789 Cafe Blvd', 15, 'me', 'visible', 'active');
...
INSERT INTO shared_events (organizer_user_id, title, start_time, end_time, timezone_id, event_details, address, reminder_minutes, reminder_scope, participant_visibility, global_state)
VALUES (1, 'Gym with Jamie',  '2026-04-29 18:00:00',  '2026-04-29 19:00:00', 'America/Los_Angeles', 'Workout session', 'FitLife Gym', 30, 'me', 'visible', 'tentative');
...
INSERT INTO shared_events (organizer_user_id, title, start_time, end_time, timezone_id, event_details, address, reminder_minutes, reminder_scope, participant_visibility, global_state)
VALUES (2, 'Movie Night with Riley',  '2026-04-26 20:00:00',  '2026-04-26 23:00:00', 'America/New_York', 'Watching the new sci-fi film', 'Riley''s Place', 60, 'all', 'visible', 'active');
...
VALUES (1, 'shared_event_accepted', 'Event Accepted', 'Alex accepted your invitation to Lunch with Alex.', 'shared_event', 2, 1);
